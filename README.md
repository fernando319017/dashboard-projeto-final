...
[requirements.txt](https://github.com/user-attachments/files/24696612/requirements.txt)
streamlit
pandas
numpy
plotly
[dashboard.py](https://github.com/user-attachments/files/24696614/dashboard.py)
